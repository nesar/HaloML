...
fileIDrangeA = np.arange(0,10,5)
fileIDAllA = ['_00'+'{}'.format(element) for element in fileIDrangeA]


fileIDrangeB = np.arange(10,55,5)
fileIDAllB = ['_0'+'{}'.format(element) for element in fileIDrangeB]#+ ['_050']

fileIDAll = fileIDAllA + fileIDAllB
...
for findex in range(np.shape(fileIDAll)[0]):

    fileID = fileIDAll[findex]
    print fileID
    
    
    #a = np.array([ 0.0196078, 0.333334, 0.509805, 0.666669, 0.901963, 1.0])
    ...
    # ---------- new simulations -------------
    dir4 = '/Volumes/lacie2/FlipFlop_Gadget/'
    #fn1 = str(int(L))+'Mpc'+str(nGr)+'/snap/'                  
    
    # -------- Misha simulations ------------
    #dir4 = '/Volumes/lacie2/GadgetResults/'
    
    fn1 = str(nGr) + 'cube' + str(int(L)) + 'Mpc_rho_ff-res' + str(res) + 'kpc/snap/'
    
                    
    
    fileIn = 'snapshot'+ fileID
    ...
    fileOut = 'npy/'+fn1+'x0_'+'snap'+ fileID+'.npy'
    np.save(fileOut,x0_3d)
    fileOut = 'npy/'+fn1+'x1_'+'snap'+ fileID+'.npy'
    np.save(fileOut,x1_3d)
    fileOut = 'npy/'+fn1+'x2_'+'snap'+ fileID+'.npy'
    np.save(fileOut,x2_3d)
    
    fileOut = 'npy/'+fn1+'flip_'+'snap'+ fileID+'.npy'
    ...
    fileOut = 'npy/'+fn1+'s0_'+'snap'+ fileID+'.npy'
    np.save(fileOut,dx0)
    fileOut = 'npy/'+fn1+'s1_'+'snap'+ fileID+'.npy'
    np.save(fileOut,dx1)
    fileOut = 'npy/'+fn1+'s2_'+'snap'+ fileID+'.npy'
    np.save(fileOut,dx2)
